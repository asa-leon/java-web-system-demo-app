...
(1, '内閣・行政改革委員会', '国家機構の改革、デジタル庁・行政手続きの効率化、公務員制度や統治機構の刷新に関する法案を審議・議論します。', 'bi-building-fill-gear'),
(2, '経済・財政・産業委員会', '税制改正、金融政策、スタートアップ支援、労働環境の改善、エネルギー産業育成など経済成長に関わる法案を扱います。', 'bi-graph-up-arrow'),
(3, '外交・安全保障委員会', '国際関係の強化、防衛政策、安全保障体制、サイバーセキュリティ対策や国際協力に関する法案を審議します。', 'bi-globe-americas'),
(4, '厚生・教育・社会保障委員会', '子育て支援、少子化対策、年金・医療制度の維持、教育改革および科学技術振興に関する法案を重点的に取り扱います。', 'bi-heart-pulse-fill'),
(5, '環境・国土インフラ委員会', '脱炭素・エネルギー政策、防災・減災対策、都市計画やインフラ老朽化対策に関する法案を審議・提案します。', 'bi-tree-fill');
